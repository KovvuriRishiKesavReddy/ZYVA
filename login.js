document.addEventListener('DOMContentLoaded', () => {
    ...
    // FIXED: Use consistent API URL across all files
    const getServerURL = () => {
        ...
        // Use the actual backend API URL for production
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const timeoutId = setTimeout(() => controller.abort(), 10000); // Increased to 10 seconds for deployed apps
    ...
    document.addEventListener('keydown', (e) => {
        ...
        if (e.key === 'Enter' && (e.target === emailInput || e.target === passwordInputField)) {
            e.preventDefault();
